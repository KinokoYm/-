<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] =='POST'){
      ...
      if(isset($_POST['search_content'])){
        $search .= '&search=' . $_POST['search_content'];
      }
    }else{
    ...
    // $page = $page < 1 ? 1 : $page;
     ...
     //======================处理页码============================
        ...
        where posts.content like '%{$search_content}%'  or posts.title like '%{$search_content}'
        ")['num'];
      ...
      <div class="panel new">
        ...
        <?php if (empty($posts_list)): ?>
            <div style="padding: 300px 0px; ">
              <p style="width: 300px ;margin:0 auto">没有找到您想要的文章,请尝试输入其他关键词!s</p>
            </div>
        <?php else: ?>
